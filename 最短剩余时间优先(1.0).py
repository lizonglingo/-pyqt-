    ...
    while (flag != len(processes)):
        if current_process != -1:
            ...
            if processes[current_process].left_serve_time == 0:
                ...
                flag += 1
                name_string += (processes[current_process].name + '   ')

                over_list_name.append(processes[current_process].name)
...
class ui(QWidget):
    ...
    def g_info(self):
        ...
        infor_list = srtf(_sorted_processes)
